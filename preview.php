<div class="preview-caldera-config-group">
	...
	<div class="preview-caldera-config-field">
		2 + 3 = <input style="max-width: 50px;" {{#if hide_label}}placeholder="{{label}}"{{else}}placeholder="{{config/placeholder}}"{{/if}} type="text" class="preview-field-config" value="{{config/default}}">
